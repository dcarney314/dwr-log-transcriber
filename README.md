...
The input file should be a raw export from the [DWR Well Permit Search](https://dwr.state.co.us/Tools/WellPermits) pasted directly into a blank Excel workbook — **no header row**. The app reads the following columns by position:
